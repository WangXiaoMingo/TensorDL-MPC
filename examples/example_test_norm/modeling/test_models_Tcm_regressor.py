...
if __name__ == '__main__':
    ...
    # TODO: 4. train model and save model
    my_model = ResnetTcm(num_blocks=1, kernel_size=3, nb_filters=16)  # 3 layers: input, hidden and output layers
    ...
    data.columns = [f'{model_name}', 'test_real']
    # data.to_excel(f'../model_result/{model_name}.xlsx')
