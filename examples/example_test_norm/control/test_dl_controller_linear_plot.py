...
if __name__ == '__main__':
    ...
    if Train_NN:
        '''get trained model'''
        import os
        script_path = '../modeling/test_models_linear_regressor.py'
        os.system(f'python {script_path}')

    model = load_model(f'../models_save/LinearRegression_predictor.h5')
    # model.summary()
    ...
    if mpc:
        ...
        result.to_excel('../model_result/Linear_MPC.xlsx')
